// DS18b20 temperature sensor connected to D5 pin (GPIO 14)
...
#define ONE_WIRE_BUS 14 // GPIO 14, nodeMCU - pin D5, connection to DS18b20 temp senosr DATA pin
...
// Configuration object for WiFi network
...
void setup() {
  ...
  //clearEEPROM(); // uncomment this line on first flash of nodeMCU board, and then comment it back and flash again - writes to EEPROM default data
  ...
  // if board is nor "activated" boot in AP mode with default SSID and password
...
String getTempPage() {
  ...
  // simply return current temperature as string
